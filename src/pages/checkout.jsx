...
import { clearCart } from "contexts/cart";
  ...
  return (
    <div className="detail-container">
      ...
      <Formik
        initialValues={{
          fullName: "Admin",
          phoneNumber: "0937485744",
          addressLine: "Lac Long Quan",
          city: "Tay Ho",
          state: "Ha Noi",
          code: "100000",
          country: "Vietnam"
      ...
      <div className="container">
        ...
        <div className="order-summary">
              ...
              return (
                <li className="cart-item" key={product.name}>
                  ...
                  <div className="product-total">
                    ...
                    <p className="amount">{product.quantity * 250000}</p>
                  </div>
                </li>
              );
            })}
          ...
          <ul className="total-breakup">
            <li>
              <p>Subtotal</p>
              <p>{items.length * 250000}</p>
            </li>
            <li>
              <p>Tax</p>
              <p>{items.length * 250000 * 0.05}</p>
            </li>
            <li>
              <p>Shipping</p>
              <p>50000</p>
            ...
            <li>
              <h2>Total</h2>
              <h2>{items.length * 250000 * 1.05 + 50000}</h2>
            </li>
          </ul>
        </div>
      </div>
